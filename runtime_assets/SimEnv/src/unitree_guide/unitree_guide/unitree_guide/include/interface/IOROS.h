...
// Gazebo continuous joints may retain an arbitrary 2*pi branch after stair
// contact or SetModelConfiguration.  Policies consume canonical angles while
// outgoing commands are mapped back to the nearest live Gazebo branch.
std::array<std::atomic<float>, 12> _raw_joint_position;
