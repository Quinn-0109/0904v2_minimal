...
if("TRUE" STREQUAL "TRUE")
  set(quadrotor_msgs_SOURCE_PREFIX /workspace/0904_v2/SimEnv-master/src/uav_simulator/Utils/quadrotor_msgs)
  set(quadrotor_msgs_DEVEL_PREFIX /workspace/0904_v2/SimEnv-master/.portable/devel)
  ...
  set(quadrotor_msgs_INSTALL_PREFIX /workspace/0904_v2/SimEnv-master/install)
...
if(NOT "/workspace/0904_v2/SimEnv-master/.portable/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'quadrotor_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/0904_v2/SimEnv-master/src/uav_simulator/Utils/quadrotor_msgs/${idir}'.  ${_report}")
    endif()
