...
if("TRUE" STREQUAL "TRUE")
  set(multi_map_server_SOURCE_PREFIX /workspace/0904_v2/SimEnv-master/src/uav_simulator/Utils/multi_map_server)
  set(multi_map_server_DEVEL_PREFIX /workspace/0904_v2/SimEnv-master/.portable/devel)
  ...
  set(multi_map_server_INSTALL_PREFIX /workspace/0904_v2/SimEnv-master/install)
...
if(NOT "/workspace/0904_v2/SimEnv-master/.portable/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/0904_v2/SimEnv-master/src/uav_simulator/Utils/multi_map_server/${idir}'.  ${_report}")
    endif()
